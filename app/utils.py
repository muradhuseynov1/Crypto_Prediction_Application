...
def generate_features(df):
    """Compute technical features for price prediction.

    Given a DataFrame with columns ['coin', 'timestamp', 'close', 'volume', 'sentiment'],
    computes pct_return_60m, sentiment_num, rolling returns/volatility, and cyclical time.
    """
    df = df.copy()
